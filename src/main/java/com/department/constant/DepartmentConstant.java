...
public class DepartmentConstant {
    ...
    public static final String EMP_ID_REGEX_MSG = "Employee ID should start with E followed by 5 digits";

    public static final String EMP_ID_REGEXP = "^[E][0-9]{5}$";

    public static final String DEPT_ID_REGEXP = "^[D][0][1-5]{1}$";
}
